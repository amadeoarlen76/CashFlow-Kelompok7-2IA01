    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gotoAdd = new Intent(HomeActivity.this, AddActivity.class);
...
//                        .setAction("Action", null).show();
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
              ...
              btn_edit.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View v) {
                      dialog.dismiss();
                      Intent gotoEdit = new Intent(HomeActivity.this, EditActivity.class);
    ...
    public void totalCash(){
        ...
        pemasukan.setText(rupiah.format(cursor.getInt(1)));
        pekeluaran.setText(rupiah.format(cursor.getInt(2)));
        total.setText(rupiah.format(cursor.getInt(1) - cursor.getInt(2)));


        if(!filter){text_filter.setText("ARUS KAS");}
        filter = false;
    }
